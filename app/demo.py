...
def main() -> None:
    ...
    print("3. Open the browser dashboard at: http://127.0.0.1:8000/app")
    print("4. Paste a supported product URL:")
    ...
    print("5. Use the Typer interface:")
    print("   python -m app.cli list-products")
    print("   python -m app.cli preview-url --product-url \"https://demo.ksp.local/products/sony-wh1000xm5\"")
    print("   python -m app.cli track-url --product-url \"https://demo.ksp.local/products/sony-wh1000xm5\" --target-price 999")
    print("   python -m app.cli summary")
    print("6. Refresh worker and protected enhancement:")
    print("   python -m scripts.refresh")
